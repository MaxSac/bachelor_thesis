...
Dafuer wird zunaechst ein Modell gelernt welches ein datenset aus gleich vielen Teilen simulierten und gemessenen (nach section \ref{sec:} zusammengestellt) Protonenen trainiert wird. 
