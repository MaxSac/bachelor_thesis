...
\begin{tikzpicture}[node distance=1.5cm]
  \draw [fill=black!09!white, draw=tugreen, rounded corners] (-1.7,1) rectangle (1.7,-3.8);
  \draw (0,0.75) node[text=tugreen!50!black] {FACT-Tools};
  ...
  \node (ROC) [NormalBox, right of=OPTI, xshift=2cm, yshift=1cm] {AUC-Wert};
