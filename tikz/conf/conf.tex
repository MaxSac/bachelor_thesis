...
\begin{tikzpicture}[node distance=3.5cm]
  ...
  \node (PRED) [NormalBox, right of=CLAS, xshift=0.5cm] {Gelabeltes Gamma};
  \node (RGAM) [AlternBox, right of=PRED, yshift=1cm] {echtes Gamma (TP)};
  \node (RPRO) [AlternBox, right of=PRED, yshift=-1cm] {echtes Proton (FP)};
