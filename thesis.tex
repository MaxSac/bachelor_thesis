...
\title{Gamma/Hadron (mit gemessenen untergrund Daten) Separation bei FACT}
\date{2017}
\birthplace{Dortmund}
\chair{Lehrstuhl für Experimentelle Physik V}
\division{Fakultät Physik}
\thesisclass{Bachelor of Science}
\submissiondate{13. September 2017}
\firstcorrector{Prof.~Dr.~Dr.~Rhode}
\secondcorrector{Prof.~Dr.~Spaan}
